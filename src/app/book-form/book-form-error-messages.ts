...
export const BookFormErrorMessages = [
 ...
 new ErrorMessage('isbn', 'isbnFormat', 'Die ISBN muss aus genau 10 oder 13 Zeichen bestehen'),
 new ErrorMessage('isbn', 'isbnExists', 'Die ISBN existiert bereits in Ihrer Datenbank'),
